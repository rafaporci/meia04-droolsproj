...
public class NetworkDiscovery {
    ...
    private static void runEngine() {
        try {
            NetworkDiscovery.justifications = new TreeMap<Integer, Justification>();

            // load up the knowledge base
            KieServices ks = KieServices.Factory.get();
            KieContainer kContainer = ks.getKieClasspathContainer();
            final KieSession kSession = kContainer.newKieSession("ksession-rules");
            NetworkDiscovery.KS = kSession;
            NetworkDiscovery.agendaEventListener = new TrackingAgendaEventListener();
            ...
            ViewChangedEventListener listener = new ViewChangedEventListener() {
                ...
                public void rowInserted(Row row) {
                    ...
                    How how = new How(NetworkDiscovery.justifications);
